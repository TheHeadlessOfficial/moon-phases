...
A conky (with a script written in Python) that shows the moon phases, using [moongiant.com](https://www.moongiant.com/) website.<br>
...
Download the .zip file, extract the file, copy the file `.conkyrc_moonpy` and the folder `.conky` inside your Linux `home`.<br>
...
<br>
The python script saves data in file so you can build your conky moon as you wish.<br>
